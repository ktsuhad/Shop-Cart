...
var requireSignin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, accessToken, decoded;
    return __generator(this, function (_a) {
        try {
            authorizationHeader = req.headers.authorization;
            if (!authorizationHeader) {
                return [2 /*return*/, res.status(401).send({ error: "Authorization header missing" })];
            }
            accessToken = authorizationHeader.split(" ")[1];
            decoded = jsonwebtoken_1.default.verify(accessToken, process.env.JWT_KEY);
            req.user = decoded;
...
var isadmin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(401).send({ success: false, message: "error in Isadmin middleware", error: error_1 });
                return [3 /*break*/, 3];
